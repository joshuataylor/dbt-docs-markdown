...
## Platform Components[​](#platform-components "Direct link to Platform Components")
...
### Sizing your SQL warehouses[​](#sizing-your-sql-warehouses "Direct link to Sizing your SQL warehouses")
...
## Patterns & Best Practices[​](#patterns--best-practices "Direct link to Patterns & Best Practices")
...
### Silver / Intermediate Layer[​](#silver--intermediate-layer "Direct link to Silver / Intermediate Layer")
...
### File Compaction[​](#file-compaction "Direct link to File Compaction")
...
### Data skipping[​](#data-skipping "Direct link to Data skipping")
...
### Analyze Table[​](#analyze-table "Direct link to Analyze Table")
...
## Performance Troubleshooting[​](#performance-troubleshooting "Direct link to Performance Troubleshooting")
...
### SQL warehouse query profile[​](#sql-warehouse-query-profile "Direct link to SQL warehouse query profile")
...
### Inefficient file pruning[​](#inefficient-file-pruning "Direct link to Inefficient file pruning")
...
### Exploding Joins[​](#exploding-joins "Direct link to Exploding Joins")
...
### Materialization Best Practices  [​](#materialization-best-practices- "Direct link to Materialization Best Practices  ")
...
1. Only read partitions that are important by pushing down filters to scan source and target using filters in *model* and *incremental\_predicates*
