...
* [Considerations](https://docs.getdbt.com/guides/core-cloud-2.md?step=3): Learn about the most important things you need to think about when moving from Core to Cloud.
* [Plan your move](https://docs.getdbt.com/guides/core-cloud-2.md?step=4): Considerations you need to make, such as user roles and permissions, onboarding order, current workflows, and more.
* [Move to dbt](https://docs.getdbt.com/guides/core-cloud-2.md?step=5): Review the steps to move your dbt Core project to dbt, including setting up your account, data platform, and Git repository.
* [Test and validate](https://docs.getdbt.com/guides/core-cloud-2.md?step=6): Discover how to ensure model accuracy and performance post-move.
* [Transition and training](https://docs.getdbt.com/guides/core-cloud-2.md?step=7): Learn how to fully transition to dbt and what training and support you may need.
* [Summary](https://docs.getdbt.com/guides/core-cloud-2.md?step=8): Summarizes key takeaways and what you've learned in this guide.
* [What's next?](https://docs.getdbt.com/guides/core-cloud-2.md?step=9): Introduces what to expect in the following guides.
...
* Check out the detailed [Move to dbt: Get started](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=1) guide for useful tasks and insights for a smooth transition from dbt Core to dbt.
...
After [setting the foundations of dbt](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=1), it's important to validate your migration to ensure seamless functionality and data integrity:
...
* **Move to dbt**: Linking to [the guide](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=1) that outlines technical steps required to transition your dbt Core project to dbt, including setting up your account, data platform, and Git repository.
