...
Unlock the power of [<Constant name="catalog" />](/docs/explore/explore-projects) in this hands-on workshop designed for analytics engineers, data analysts, stakeholders, and data leaders.

This quickstart guide accompanies the <Constant name="catalog" /> hands-on workshop and helps you dive into a production-level <Constant name="mesh" /> implementation and discover how to explore your data workflows.⁠ Whether you're looking to streamline your data operations, improve data quality, or self-serve information about your data platform, this workshop will equip you with the tools and knowledge to take your dbt projects to the next level.

By the end of the guide and workshop, you'll understand how to leverage <Constant name="catalog" /> and have the confidence to navigate multiple dbt projects, trace dependencies, and identify opportunities to improve performance and data quality.

### What you'll learn
In this guide, you will learn how to:
- Navigate multiple dbt projects using <Constant name="catalog" />
...
## Setup
Now we’ll be creating your <Constant name="dbt" /> account and connecting it to a data warehouse. 
1. Go to this URL (sign out if you're already logged in): https://cloud.getdbt.com/coalesce-workshop-signup
2. Enter your first name and last name.
3. Select the **Exploring a <Constant name="mesh" /> implementation with <Constant name="catalog" />** option.
...
6. Wait about 30 seconds, you’ll be in the <Constant name="dbt" /> account for this workshop and already connected to a data warehouse.
...
With <Constant name="catalog" />, you can view your project's resources (such as models, tests, and metrics), their lineage, and model consumption to gain a better understanding of its latest production state. 
...
## Multi-project
Use <Constant name="catalog" /> to gain a deeper understanding of *all* your <Constant name="dbt" /> projects with its [multi-project capabilities](/docs/explore/explore-multiple-projects).
...
Congratulations! You've completed the <Constant name="catalog" /> workshop. You now have the tools and knowledge to navigate multiple dbt projects, trace dependencies, and identify opportunities to improve performance and data quality.

You've learned how to:
- Use <Constant name="catalog" /> to visualize your project’s lineage and interact with the DAG
