...
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [Move from dbt Core to dbt platform: What you need to know](https://docs.getdbt.com/guides/core-cloud-2.md) | Understand the considerations and methods needed in your move from dbt Core to dbt platform. | Team leads<br />Admins                            |
| [Move from dbt Core to dbt platform: Get started](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=1) | Learn the steps needed to move from dbt Core to dbt platform.                                | Developers<br />Data engineers<br />Data analysts |
| [Move from dbt Core to dbt platform: Optimization tips](https://docs.getdbt.com/guides/core-to-cloud-3.md)  | Learn how to optimize your dbt experience with common scenarios and useful tips.             | Everyone                                          |
...
* [Account setup](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=4): Learn how to create a dbt account, invite team members, and configure it for your team.
* [Data platform setup](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=5): Find out about connecting your data platform to dbt.
* [Git setup](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=6): Learn to link your dbt project's Git repository with dbt.
* [Developer setup:](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=7) Understand the setup needed for developing in dbt.
* [Environment variables](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=8): Discover how to manage environment variables in dbt, including their priority.
* [Orchestration setup](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=9): Learn how to prepare your dbt environment and jobs for orchestration.
* [Models configuration](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=10): Get insights on validating and running your models in dbt, using either the Studio IDE or dbt CLI.
* [What's next?](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=11): Summarizes key takeaways and introduces what to expect in the following guides.
...
* [dbt environments](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=7#dbt-cloud-environments)
* [Initial setup steps](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=7#initial-setup-steps)
* [Additional configuration](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=7#additional-configuration-2)
* [dbt commands](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=7#dbt-cloud-commands)
...
* [Environment variables in dbt](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=7#environment-variables-in-dbt-cloud)
* [dbt environment variables order of precedence](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=7#dbt-cloud-environment-variables-order-of-precedence)
* [Set environment variables in dbt](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=7#set-environment-variables-in-dbt-cloud)
...
* [dbt environments](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=8#dbt-cloud-environments-1)
* [Initial setup steps](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=8#initial-setup-steps-1)
* [Additional configuration](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=8#additional-configuration-3)
* [CI/CD setup](https://docs.getdbt.com/guides/core-to-cloud-1.md?step=8#cicd-setup)
