...
* [Create a virtual development environment](https://docs.getdbt.com/docs/core/pip-install.md#using-virtual-environments) using a template provided by dbt Labs.
...
* [DuckDB setup](https://docs.getdbt.com/docs/core/connect-data-platform/duckdb-setup.md)
...
For more information, refer to the [DuckDB setup](https://docs.getdbt.com/docs/core/connect-data-platform/duckdb-setup.md).
