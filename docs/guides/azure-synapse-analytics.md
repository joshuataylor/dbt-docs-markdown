...
## Load data into your Azure Synapse Analytics[​](#load-data-into-your-azure-synapse-analytics "Direct link to Load data into your Azure Synapse Analytics")
...
5. Copy these statements into the SQL editor to load the Jaffle Shop example data:
   ...
   [![Example of loading data](/img/quickstarts/dbt-cloud/example-load-data-azure-syn-analytics.png?v=2 "Example of loading data")](#)Example of loading data

## Connect dbt to Azure Synapse Analytics[​](#connect-dbt-to-azure-synapse-analytics "Direct link to Connect dbt to Azure Synapse Analytics")
