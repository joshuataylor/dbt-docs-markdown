...
* [Local command line interface (CLI) tools](https://docs.getdbt.com/docs/fusion/install-fusion-cli.md) [Preview](https://docs.getdbt.com/docs/dbt-versions/product-lifecycles "Go to https://docs.getdbt.com/docs/dbt-versions/product-lifecycles")
...
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Studio IDE**           | Fusion is automatically enabled; just [upgrade your environment(s)](https://docs.getdbt.com/docs/dbt-versions/upgrade-dbt-version-in-cloud.md#dbt-fusion-engine). |
| **dbt CLI (local)**      | [Install dbt Fusion engine](https://docs.getdbt.com/docs/fusion/install-fusion-cli.md) locally following this guide.                                              |
...
* You should have a basic understanding of [dbt projects](https://docs.getdbt.com/docs/build/projects.md), [git workflows](https://docs.getdbt.com/docs/cloud/git/git-version-control.md), and [data warehouse requirements](https://docs.getdbt.com/docs/supported-data-platforms.md).
...
The following are the essential steps from the [dbt Fusion engine](https://docs.getdbt.com/docs/fusion/install-fusion-cli.md) and [extension](https://docs.getdbt.com/docs/install-dbt-extension.md) installation guides:
...
3. Click **Install**.
4. When the prompt appears, you can register the extension now or skip it (you can register later). You can also check out our [installation instructions](https://docs.getdbt.com/docs/install-dbt-extension.md) to come back to it later.
