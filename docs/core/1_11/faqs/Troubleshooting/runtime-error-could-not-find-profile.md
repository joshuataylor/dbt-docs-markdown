...
**In the Studio IDE:** If this is happening in the Studio IDE, you'll want to navigate to the Profile settings where your user credentials are configured. Once you're there, you'll need to either re-enter or re-authorize your credentials in order to get around this error message.
