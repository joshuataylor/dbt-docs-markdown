# Studio IDE freezes when opening the Lineage tab

If the Studio IDE freezes with two or more models open and the **Lineage** tab active, use the following workarounds.

### Why this happens[​](#why-this-happens "Direct link to Why this happens")

The Studio IDE can freeze when the **Lineage** tab is open or loads automatically, and when two or more models are open, especially if a model has a large or slow-loading DAG.

## What you might observe[​](#what-you-might-observe "Direct link to What you might observe")

* The editor becomes unresponsive.
* After a few minutes, your browser may display a **Wait** or **Exit** dialog.

## Workaround 1: Avoid the Lineage tab on startup[​](#workaround-1-avoid-the-lineage-tab-on-startup "Direct link to Workaround 1: Avoid the Lineage tab on startup")
...
## Workaround 2: Clear Local Storage for your account URL[​](#workaround-2-clear-local-storage-for-your-account-url "Direct link to Workaround 2: Clear Local Storage for your account URL")
...
### Google Chrome and Microsoft Edge[​](#google-chrome-and-microsoft-edge "Direct link to Google Chrome and Microsoft Edge")

1. Open the dbt platform page that’s freezing.
...
1. Open Safari and go to the dbt platform page that’s freezing.
