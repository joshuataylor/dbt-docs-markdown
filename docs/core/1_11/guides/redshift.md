...
To avoid connectivity issues with dbt, make sure to allow inbound traffic on port 5439 from [dbt's IP addresses](https://docs.getdbt.com/docs/platform/about-platform/access-regions-ip-addresses.md) in your Redshift security groups and Network Access Control Lists (NACLs) settings.
...
1. Create a new project in [dbt](https://docs.getdbt.com/docs/platform/about-platform/access-regions-ip-addresses.md). Navigate to **Account settings** (by clicking on your account name in the left side menu), and click **+ New Project**.
...
5. Enter your Redshift settings. Reference your credentials you saved from the CloudFormation template.
   ...
   * Allow inbound traffic on port `5439` from [dbt's IP addresses](https://docs.getdbt.com/docs/platform/about-platform/access-regions-ip-addresses.md) in your Redshift security groups and Network Access Control Lists settings.
