...
[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/dbt-versions.md)

#### [About dbt versions](https://docs.getdbt.com/docs/dbt-versions.md)
...
[Learn about how versions of dbt align with the release tracks available on the dbt platform.](https://docs.getdbt.com/docs/dbt-versions/dbt-release-tracks.md)

[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/dbt-versions/upgrade-dbt-platform-version.md)

#### [Upgrade versions in dbt platform](https://docs.getdbt.com/docs/dbt-versions/upgrade-dbt-platform-version.md)

[Instructions for upgrading your dbt platform projects to the latest version of dbt, including the Fusion Engine.](https://docs.getdbt.com/docs/dbt-versions/upgrade-dbt-platform-version.md)
