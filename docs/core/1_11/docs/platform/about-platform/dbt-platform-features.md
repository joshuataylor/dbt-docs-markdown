...
[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/platform/dbt-cli-installation.md)

#### [dbt CLI](https://docs.getdbt.com/docs/platform/dbt-cli-installation.md)

[Use the CLI for the dbt platform to develop, test, run, and version control dbt projects and commands, directly from the command line.](https://docs.getdbt.com/docs/platform/dbt-cli-installation.md)

[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/platform/studio-ide/develop-in-studio.md)

#### [dbt Studio IDE](https://docs.getdbt.com/docs/platform/studio-ide/develop-in-studio.md)

[The IDE is the easiest and most efficient way to develop dbt models, allowing you to build, test, run, and version control your dbt projects directly from your browser.](https://docs.getdbt.com/docs/platform/studio-ide/develop-in-studio.md)

[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/platform/canvas.md)

#### [dbt Canvas](https://docs.getdbt.com/docs/platform/canvas.md)

[Develop with Canvas, a seamless drag-and-drop experience that helps analysts quickly create and visualize dbt models in dbt.](https://docs.getdbt.com/docs/platform/canvas.md)

[![](/img/icons/wizard.svg)](https://docs.getdbt.com/docs/platform/wizard-overview.md)

#### [dbt Wizard\*](https://docs.getdbt.com/docs/platform/wizard-overview.md)

[dbt Wizard is an AI agent that helps teams ship higher-quality dbt changes faster and with less risk. Built for governed data development in dbt, dbt Wizard has full project context and assesses how changes impact the projects.](https://docs.getdbt.com/docs/platform/wizard-overview.md)
...
[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/platform/git/connect-github.md)

#### [Supports GitHub, GitLab, AzureDevOps](https://docs.getdbt.com/docs/platform/git/connect-github.md)

[Seamlessly connect your git account to the dbt platform and provide another layer of security to dbt. Import new repositories, trigger continuous integration, clone repos using HTTPS, and more!](https://docs.getdbt.com/docs/platform/git/connect-github.md)
...
[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/platform-integrations/downstream-exposures.md)

#### [Visualize and orchestrate exposures\*](https://docs.getdbt.com/docs/platform-integrations/downstream-exposures.md)

[Configure downstream exposures automatically from dashboards and understand how models are used in downstream tools. Proactively refresh the underlying data sources during scheduled dbt jobs.](https://docs.getdbt.com/docs/platform-integrations/downstream-exposures.md)
...
[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/dbt-apis/discovery-api.md)

#### [Discovery API\*](https://docs.getdbt.com/docs/dbt-apis/discovery-api.md)

[Enhance your workflow and run ad-hoc queries, browse schema, or query the dbt Semantic Layer. dbt serves a GraphQL API, which supports arbitrary queries.](https://docs.getdbt.com/docs/dbt-apis/discovery-api.md)
...
[](https://docs.getdbt.com/docs/explore/cost-insights.md)

[](https://docs.getdbt.com/docs/explore/cost-insights.md)

[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/explore/cost-insights.md)[Beta](https://docs.getdbt.com/docs/dbt-versions/product-lifecycles "Go to https://docs.getdbt.com/docs/dbt-versions/product-lifecycles")
