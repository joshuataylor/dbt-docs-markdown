...
## dbt State usage[​](#dbt-state-usage "Direct link to dbt State usage")

[dbt state](https://docs.getdbt.com/docs/deploy/dbt-state-about.md) enables dbt to reuse nodes by cloning from another location or skipping a rebuild when the logic and data haven't changed. Learn more about how your usage influences the price so you can plan your savings effectively.
...
### dbt State pricing[​](#dbt-state-pricing "Direct link to dbt State pricing")
...
## dbt AI: Usage metering and limiting [Starter](https://www.getdbt.com/pricing "Go to https://www.getdbt.com/pricing")[Enterprise](https://www.getdbt.com/pricing "Go to https://www.getdbt.com/pricing")Enterprise+[​](#dbt-ai-usage-metering-and-limiting- "Direct link to dbt-ai-usage-metering-and-limiting-")
...
5. Modify your dbt jobs to include `dbt run --selector skip_views_but_test_views`.
