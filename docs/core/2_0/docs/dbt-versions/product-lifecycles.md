...
We release dbt Core in the following lifecycle states. Core releases follow semantic versioning, which you can read more about in [About dbt versions](https://docs.getdbt.com/docs/dbt-versions.md).
