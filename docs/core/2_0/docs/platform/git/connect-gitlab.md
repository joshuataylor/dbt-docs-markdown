...
* All repositories that users access from the dbt platform must belong to a [GitLab group](https://docs.gitlab.com/user/group/).
...
2. [Add the GitLab app to dbt](#adding-the-gitlab-oauth-application-to-dbt).
