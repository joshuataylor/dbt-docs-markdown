...
* [Connecting to a data platform](https://docs.getdbt.com/docs/platform/connect-data-platform/about-connections.md)
* Configuring access to [GitHub](https://docs.getdbt.com/docs/platform/git/connect-github.md), [GitLab](https://docs.getdbt.com/docs/platform/git/connect-gitlab.md), or your own [git repo URL](https://docs.getdbt.com/docs/platform/git/import-a-project-by-git-url.md).
* [Managing users and licenses](https://docs.getdbt.com/docs/platform/manage-access/seats-and-users.md)
* [Configuring secure access](https://docs.getdbt.com/docs/platform/manage-access/about-user-access.md)

For steps on installing dbt development tools, refer to the [dbt CLI](https://docs.getdbt.com/docs/platform/dbt-cli-installation.md) or the [Studio IDE (browser-based)](https://docs.getdbt.com/docs/platform/studio-ide/develop-in-studio.md).
