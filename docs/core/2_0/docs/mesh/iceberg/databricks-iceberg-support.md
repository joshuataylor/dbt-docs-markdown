...
| -------------------- | ---------------------------------------------- | -------- | -------------------------------------------------------------------------------------------- |
| `name`               | Name of catalog integration                    | Yes      | "my\_write\_integration"                                                                     |
| `catalog_type`       | Type of catalog                                | Yes      | unity, hive\_metastore                                                                       |
