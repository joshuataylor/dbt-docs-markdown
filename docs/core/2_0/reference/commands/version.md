...
To learn more about release versioning for dbt Core, refer to [How dbt Core uses semantic versioning](https://docs.getdbt.com/docs/dbt-versions.md#how-dbt-core-uses-semantic-versioning).
