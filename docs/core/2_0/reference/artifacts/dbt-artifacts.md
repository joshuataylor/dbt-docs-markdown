...
When running commands from the [dbt CLI](https://docs.getdbt.com/docs/platform/dbt-cli-installation.md), all artifacts are downloaded by default. If you want to change this behavior, refer to [How to skip artifacts from being downloaded](https://docs.getdbt.com/docs/platform/configure-dbt-cli.md#how-to-skip-artifacts-from-being-downloaded).
