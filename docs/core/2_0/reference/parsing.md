...
* Partial parsing [profile config](https://docs.getdbt.com/docs/local/profiles.yml.md#partial_parse) and [CLI flags](https://docs.getdbt.com/reference/global-configs/parsing.md)
