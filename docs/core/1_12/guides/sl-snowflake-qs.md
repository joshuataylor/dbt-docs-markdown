...
[Semantic models](https://docs.getdbt.com/docs/build/semantic-models.md) contain many object types (such as entities, simple metrics, and dimensions) that allow MetricFlow to construct the queries for metric definitions.
...
The following sections explain [dimensions](https://docs.getdbt.com/docs/build/dimensions.md), [entities](https://docs.getdbt.com/docs/build/entities.md), and [simple metrics](https://docs.getdbt.com/docs/build/metrics-overview.md#simple-metrics) in more detail, showing how they each play a role in semantic models.
...
[Simple metrics](https://docs.getdbt.com/docs/build/simple.md) perform an aggregation (like `sum`, `count`, or `average`, and so on) on a single field in your model. They replace the concept of "measures" in previous versions. To define more advanced metrics, refer to [Define metrics and add a second semantic model](https://docs.getdbt.com/guides/sl-snowflake-qs.md?step=10).
