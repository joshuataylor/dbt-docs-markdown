...
[![](/img/icons/computer.svg)](https://docs.getdbt.com/reference/semantic-layer-reference.md)

#### [Semantic Layer configurations](https://docs.getdbt.com/reference/semantic-layer-reference.md)

[Complete configuration reference for semantic models, metrics, and dimensions in the dbt Semantic Layer.](https://docs.getdbt.com/reference/semantic-layer-reference.md)
