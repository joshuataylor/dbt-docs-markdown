...
### Unsupported materializations[​](#unsupported-materializations "Direct link to Unsupported materializations")
...
## Materialization-specific configurations[​](#materialization-specific-configurations "Direct link to Materialization-specific configurations")

### `streaming_table`[​](#streaming_table "Direct link to streaming_table")

The `streaming_table` materialization creates a Kafka-topic-backed table and a continuously running `INSERT INTO` statement.

models/my\_streaming\_model.sql
...
#### `with` config[​](#with-config "Direct link to with-config")
...
### `streaming_source`[​](#streaming_source "Direct link to streaming_source")
...
#### `connector` config[​](#connector-config "Direct link to connector-config")
...
## Stateful behavior and `--full-refresh`[​](#stateful-behavior-and---full-refresh "Direct link to stateful-behavior-and---full-refresh")
