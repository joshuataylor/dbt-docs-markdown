...
2. [Our Jinja function reference](/reference/dbt-jinja-functions-context-variables): This documents any additional functionality we've added to Jinja in dbt.
