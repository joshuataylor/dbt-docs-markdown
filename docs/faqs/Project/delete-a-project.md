...
To delete a project in <Constant name="dbt" />, you must be the account owner or have admin privileges. 
...
<Lightbox src="/img/docs/dbt-platform/delete_projects_from_dbt_cloud.png" title="Delete projects" />
