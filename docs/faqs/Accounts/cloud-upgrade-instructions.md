...
* You *must* be part of the [Owner](https://docs.getdbt.com/docs/cloud/manage-access/self-service-permissions.md) user group to make billing changes. Users not included in this group will not see these options.
...
* Under **Billing**, you can review the available dbt [plans](https://www.getdbt.com/pricing/) and their features
...
[![](/img/docs/dbt-cloud/downgrade-dev-flow.gif?v=2)](#)
...
[![](/img/docs/dbt-cloud/trial-team-flow.png?v=2)](#)

[![](/img/docs/dbt-cloud/trial-team-payments-flow.png?v=2)](#)
...
[![](/img/docs/dbt-cloud/enterprise-upgrade.gif?v=2)](#)
...
Currently, dbt Starter plan payments must be made with a credit card, and by default they will be billed monthly based on the number of [developer seats and usage](https://docs.getdbt.com/docs/cloud/billing.md).
