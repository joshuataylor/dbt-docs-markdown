...
- `dbt clone` is only available with dbt version 1.6 and newer. Refer to our [upgrade guide](/docs/dbt-versions/upgrade-dbt-platform-version) for help enabling newer versions in <Constant name="dbt" />.
