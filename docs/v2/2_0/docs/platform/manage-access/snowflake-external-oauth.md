...
[![The issuer and jws keys URIs in the metadata URL](/img/docs/dbt-platform/gather-uris.png?v=2 "The issuer and jws keys URIs in the metadata URL")](#)The issuer and jws keys URIs in the metadata URL
