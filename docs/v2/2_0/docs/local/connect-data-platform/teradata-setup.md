...
The adapter is published using Apache-2.0 License. Refer to the [terms and conditions](https://github.com/dbt-labs/dbt-oss/blob/main/LICENSE) to understand items such as creating derivative work and the support model.
