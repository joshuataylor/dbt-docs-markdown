...
| --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| All metadata                                              | [dbt build](../../reference/commands/build.md), [dbt docs generate](../../reference/commands/cmd-docs.md), and [dbt source freshness](../../reference/commands/source.md#freshness) together as part of the same job in the environment |
...
| Source freshness results                                  | [dbt source freshness](../../reference/commands/source.md#freshness) within a job in the environment                                                                                                                                                                        |
