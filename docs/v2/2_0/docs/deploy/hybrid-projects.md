...
* dbt Core and dbt users can navigate to [Catalog](https://docs.getdbt.com/docs/explore/explore-projects.md) and view their models and assets. To view Catalog, you must have a [read-only seat](https://docs.getdbt.com/docs/platform/manage-access/seats-and-users.md).
...
* You're on [dbt's release tracks](https://docs.getdbt.com/docs/dbt-versions/dbt-release-tracks.md) and your dbt Core project is on dbt v1.10 or higher
...
* Update [dbt permissions](https://docs.getdbt.com/docs/platform/manage-access/enterprise-permissions.md) to create a new project in dbt
