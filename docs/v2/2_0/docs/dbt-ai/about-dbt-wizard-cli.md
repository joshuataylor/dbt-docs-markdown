...
For a first session walkthrough, visit [Use dbt Wizard locally](./wizard-quickstart.md).
...
For more examples, visit [Use cases and examples](./wizard-use-cases.md).
...
[Install dbt Wizard locally, complete first-run onboarding, and send your first prompt.](./wizard-quickstart.md)

[![](/img/icons/wizard.svg)](./wizard-cli.md)

#### [Install and update](./wizard-cli.md)

[Install, verify, update, and uninstall the dbt Wizard CLI on your machine.](./wizard-cli.md)

[![](/img/icons/wizard.svg)](./wizard-byok.md)

#### [BYOK configuration](./wizard-byok.md)

[Bring your own API key and choose a supported AI provider.](./wizard-byok.md)

[![](/img/icons/wizard.svg)](./wizard-skills.md)

#### [Use skills](./wizard-skills.md)

[Give dbt Wizard reusable instructions for your project.](./wizard-skills.md)

[![](/img/icons/wizard.svg)](./wizard-subagents.md)

#### [Use subagents](./wizard-subagents.md)

[Organize long-running dbt Wizard work into focused agent threads.](./wizard-subagents.md)

[![](/img/icons/wizard.svg)](./wizard-mcp.md)

#### [Use MCP servers](./wizard-mcp.md)

[Connect the dbt Wizard CLI to MCP servers for more tools and context.](./wizard-mcp.md)

[![](/img/icons/wizard.svg)](./wizard-headless.md)

#### [Headless mode](./wizard-headless.md)

[Run dbt Wizard in scripts and CI with exec, review, and other headless workflows.](./wizard-headless.md)

[![](/img/icons/wizard.svg)](./wizard-migrate.md)

#### [Migrate to dbt Wizard](./wizard-migrate.md)

[Move Claude Code project context, skills, and settings into dbt Wizard.](./wizard-migrate.md)

[![](/img/icons/wizard.svg)](./wizard-cli-reference.md)

#### [Command reference](./wizard-cli-reference.md)

[Curated reference for common wizard subcommands and global flags.](./wizard-cli-reference.md)

[![](/img/icons/wizard.svg)](./wizard-slash-commands.md)

#### [Slash command reference](./wizard-slash-commands.md)

[Full reference for interactive TUI slash commands.](./wizard-slash-commands.md)

[![](/img/icons/wizard.svg)](./wizard-config.md)

#### [Config reference](./wizard-config.md)

[Configure agent runtime defaults and per-project dbt Wizard settings.](./wizard-config.md)

[![](/img/icons/wizard.svg)](./wizard-telemetry.md)

#### [Data & privacy](./wizard-telemetry.md)

[Understand what dbt Wizard CLI collects and how to opt out.](./wizard-telemetry.md)
