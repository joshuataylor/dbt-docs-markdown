...
| `lakehouse_catalog`     | String | No                                                                                         | The name of the LRC that holds this catalog's tables.                                   | New spec only, and requires dbt v2 (v2). Set it in `catalogs.yml`, not per model. |
...
`lakehouse_catalog` requires the [dbt v2](../../../introduction.md) (v2) with the `use_catalogs_v2` behavior flag enabled.
