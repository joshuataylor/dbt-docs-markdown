...
[The dbt platform CLI provides the dbt environment command for environment and connection details. If you're using or , use dbt debug to inspect profile, target, and connection \&mdash; or use dbtf debug if you have both Core/Fusion and platform CLIs and want to inspect .](../reference/commands/dbt-environment.md)
...
[The dbt invocation command is available in the and allows you to:](../reference/commands/invocation.md)
...
## [login](../reference/commands/login.md)

[Use dbt login to authenticate and unlock advanced features across dbt tools.](../reference/commands/login.md)
