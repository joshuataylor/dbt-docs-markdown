...
* Verify that platform metadata credentials are configured in your account settings and that the credential test is passing. For more information, see [Set up Cost Insights](../../docs/explore/set-up-cost-insights.md#configure-platform-metadata-credentials).
* Ensure you have one of the required permissions to view cost data. For more information, see [Assign required permissions](../../docs/explore/set-up-cost-insights.md#assign-required-permissions).
