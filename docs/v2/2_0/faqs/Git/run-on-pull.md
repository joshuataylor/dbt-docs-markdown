...
If it was added via a deploy key method, you'll want to use the [GitHub auth method](https://docs.getdbt.com/docs/platform/git/connect-github.md) to enable CI in dbt.
