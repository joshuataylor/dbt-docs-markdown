...
For detailed installation instructions, refer to [Install the dbt CLI](../docs/platform/dbt-cli-installation.md?version=1.10).
...
* [Fusion releases and release channels](../docs/fusion/fusion-releases.md)
