...
We also recommend ensuring your package is compatible with [Fusion](../docs/introduction.md) and [dbt Core](../docs/local/install-dbt.md). To ensure Fusion compatibility, you can follow the steps in the [Fusion package upgrade guide](./dbt-package-compat.md).
...
If you're building a package, we recommend you ensure it's compatible with [Fusion](../docs/introduction.md) and [dbt Core](../docs/local/install-dbt.md). To ensure Fusion compatibility, you can follow the steps in the [Fusion package upgrade guide](./dbt-package-compat.md).
