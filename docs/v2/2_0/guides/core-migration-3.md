...
* [Adapters and connections](./core-migration-3.md?step=3)
* [Development tools](./core-migration-3.md?step=4)
* [Orchestration](./core-migration-3.md?step=5)
* [Mesh](./core-migration-3.md?step=6)
...
* dbt automatically [cancels](../docs/deploy/job-scheduler.md#run-cancellation-for-over-scheduled-jobs) a scheduled run if the existing run is still executing. This prevents unnecessary, duplicative executions.
...
* Our [Support team](../docs/dbt-support.md) is always available to help you troubleshoot your dbt issues.
