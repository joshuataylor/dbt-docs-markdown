...
2. Click **Create environment** and fill out the **General settings**.
   * Your **dbt version** must be on a [release track](../docs/dbt-versions/dbt-release-tracks.md) to use the Athena connection.
...
Repeat the process to create a [development environment](../docs/dbt-platform-environments.md#types-of-environments).
