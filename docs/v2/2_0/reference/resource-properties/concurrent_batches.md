...
Available from dbt v1.9 or with the [dbt "v1 Latest" release track](../../docs/dbt-versions/dbt-release-tracks.md).
...
* You've configured a [microbatch incremental strategy](../../docs/build/incremental-microbatch.md).
