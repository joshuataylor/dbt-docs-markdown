...
* The `--info <view>` flag queries the [dbt Information Schema](../../docs/build/dbt-information-schema.md) directly from the CLI. It reads from the intermediate views and doesn't connect to your warehouse.
