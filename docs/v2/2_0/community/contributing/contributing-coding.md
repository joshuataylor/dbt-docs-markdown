...
### Contribute to dbt open source or source-available software
...
* Read the dbt Core [contribution guide](https://github.com/dbt-labs/dbt-oss/blob/main/CONTRIBUTING.md) and the [Contributor Expectations](../resources/contributor-expectations.md).
