...
| `engine:`     | `engine:v1`, `engine:v2`                                                                                                          | Which dbt engine the issue concerns: `engine:v1` is the Python engine (dbt v1); `engine:v2` is the v2 Rust rewrite. |
