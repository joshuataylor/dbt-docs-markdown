...
Once you've created your semantic models, it's time to start referencing those (Applies to dbt v1.11 and earlier) measures you made to create some metrics:
