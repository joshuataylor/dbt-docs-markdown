...
* You must have a [dbt Enterprise-tier account](https://www.getdbt.com/contact) [Enterprise](https://www.getdbt.com/pricing "Go to https://www.getdbt.com/pricing")[Enterprise +](https://www.getdbt.com/pricing "Go to https://www.getdbt.com/pricing")
...
1. First, navigate to the **Studio IDE** page to verify your setup.
...
* [Hybrid development with dbt platform and dbt v2](./dbt-platform-local-workflow.md) — keep your local and platform environments in sync across credentials, env vars, and dbt v2 versions
