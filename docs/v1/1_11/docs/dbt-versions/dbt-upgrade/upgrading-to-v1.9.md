...
* [`freshness`](../../../reference/resource-configs/freshness.md) for sources
  * dbt v2 [expands freshness checks](./upgrading-to-v2.md?version=2#model-freshness-and-the-dbt-freshness-command) to support models.
