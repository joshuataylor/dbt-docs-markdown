...
## BigQuery-specific configs for `biglake_metastore` catalogs[​](#bigquery-specific-configs-for-biglake_metastore-catalogs "Direct link to bigquery-specific-configs-for-biglake_metastore-catalogs")
