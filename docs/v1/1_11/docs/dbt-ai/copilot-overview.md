...
* [dbt Copilot in Studio IDE](../platform/studio-ide/develop-studio-ai.md): Generate SQL, documentation, tests, and semantic models with single-click buttons directly in the Studio IDE
