...
6. Click **Edit** and enter the **SCIM base URL** from [Set up SCIM](./scim.md#set-up-dbt) in the first field. For **Unique identifier field for users**, we recommend `userName`.
