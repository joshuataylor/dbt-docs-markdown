...
dbt is available in most regions around the world in both [single tenant](https://docs.getdbt.com/docs/platform/about-platform/tenancy.md#single-tenant) (AWS and Azure) and [multi-tenant](https://docs.getdbt.com/docs/platform/about-platform/tenancy.md#multi-tenant) configurations.
