...
* (Optional) To enable [Language Server Protocol (LSP) features](./navigate-dbt-insights.md#lsp-features-in-dbt-insights) in Insights and run your compilations on dbt v2, set your development environment to use the **v2 Stable** dbt version.
