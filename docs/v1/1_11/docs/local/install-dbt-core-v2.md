...
To upgrade an existing v1 project to v2, refer to [Upgrade to v2](../dbt-versions/core-upgrade/upgrading-to-v2.md?version=2.0).

To understand the differences between dbt Core v1.x, dbt Core 2.0, and Fusion, refer to [dbt licensing](../dbt-licensing.md?version=2.0).
