...
| [Extrica](https://docs.getdbt.com/docs/local/connect-data-platform/extrica-setup.md)                        | [Hologres](https://docs.getdbt.com/docs/local/connect-data-platform/hologres-setup.md)            |                                                                                                    |
| [IBM watsonx.data - Spark](https://docs.getdbt.com/docs/local/connect-data-platform/watsonx-spark-setup.md) | [Infer](https://docs.getdbt.com/docs/local/connect-data-platform/infer-setup.md)                  |                                                                                                    |
