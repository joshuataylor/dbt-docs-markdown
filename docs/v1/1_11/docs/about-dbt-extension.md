...
The dbt VS Code extension is available with v2 and brings editor features like autocomplete, inline errors, preview CTE, LSP, and more! [Upgrade to v2](./dbt-versions/dbt-upgrade/upgrading-to-v2.md) to use it.
