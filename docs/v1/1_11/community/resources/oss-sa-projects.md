...
* [dbt Core 2.0](https://github.com/dbt-labs/dbt-oss) - the next major version of dbt Core, powered by the dbt Fusion engine (previously in [`dbt-fusion`](https://github.com/dbt-labs/dbt-fusion))

## Python

* [dbt Core](https://github.com/dbt-labs/dbt-oss/tree/1.latest) - the original engine powering dbt
