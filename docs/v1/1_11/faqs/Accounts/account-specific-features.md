...
dbt Wizard codegen uses metadata such as relationships, lineage, and model context from your dbt projects to produce contextually accurate code. This helps avoid mistakes common with generic AI tools by ensuring generated code matches your actual schema and conventions.⁠⁠⁠⁠

The code dbt Wizard generates may include:
...
The dbt Wizard experience with BYOK and Azure OpenAI will not use metadata information in Insights, Canvas, or the Studio IDE.
