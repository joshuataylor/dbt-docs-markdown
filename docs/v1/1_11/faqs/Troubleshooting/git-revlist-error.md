...
1. Disconnect and reconnect your repository [connection](../../docs/platform/git/import-a-project-by-git-url.md) on your Project Settings page. This should then allow dbt to pick up that the "main" branch is now called `main`.
...
1. Disconnecting and reconnecting your repository [connection](../../docs/platform/git/import-a-project-by-git-url.md) on your Project Settings page. This should then allow dbt to pick up that the "main" branch is now called `main`.
