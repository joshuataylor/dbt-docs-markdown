...
* Rather than enforcing uniqueness and not-null constraints on your column, use dbt's [data testing](../../docs/build/data-tests.md) functionality to check that your assertions about your model hold true.
