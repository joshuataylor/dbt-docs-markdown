...
For implementation details, refer to the source definitions of `dbtRunner` and `dbtRunnerResult` in the [dbt Core repository](https://github.com/dbt-labs/dbt-oss/blob/1.latest/core/dbt/cli/main.py).
