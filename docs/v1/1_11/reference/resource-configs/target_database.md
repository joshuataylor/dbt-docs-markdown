...
Starting in dbt v1.9+, this functionality is no longer utilized. Use the [database](./database.md) config as an alternative to define a custom database while still respecting the `generate_database_name` macro.
