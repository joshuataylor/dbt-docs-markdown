...
At the same time, for models with many columns, we understand that this can mean a *lot* of YAML. See [dbt-core#11764](https://github.com/dbt-labs/dbt-oss/issues/11764) for discussion of potential approaches to generate and update model contract definitions.
