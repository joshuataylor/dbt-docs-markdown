...
Starting in `dbt-snowflake` v1.12, the `snowflake_managed_iceberg_default` [behavior flag](../../../../reference/global-configs/snowflake-changes.md#the-snowflake_managed_iceberg_default-flag) controls this behavior:
