...
| ----------------------------- | ------- | ----------------------------------------------------------------------------------------------- |
| `DISABLE_DBT_CLI`             | `false` | Disable local dbt CLI tools (dbt v1.x and v2).                                                  |
...
| ------------------------------- | -------------------------------------------------------------- |
| `DBT_MCP_ENABLE_DBT_CLI`        | Set to `true` to enable local dbt CLI tools (dbt v1.x and v2). |
