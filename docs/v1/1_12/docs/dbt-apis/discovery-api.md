...
You can access the Discovery API through [ad hoc queries](./discovery-querying.md), custom applications, a wide range of [partner ecosystem integrations](https://www.getdbt.com/product/integrations/) (like BI/analytics, catalog and governance, and quality and observability), and by using dbt features like [model timing](../deploy/run-visibility.md#model-timing-tab) and [data health tiles](../explore/data-tile.md).
...
* **Definition** — The logical state of a dbt project’s [resources](../build/projects.md) that update when the project is changed.
