...
#### [Personal access tokens](./user-tokens.md)

[Learn about user tokens and how to use them to execute queries against the dbt API.](./user-tokens.md)

[![](/img/icons/dbt-bit.svg)](./service-tokens.md)

#### [Service account tokens](./service-tokens.md)
...
* **dbt platform CLI** — Use a PAT since the dbt platform CLI works within the context of a user (the user is making the requests and has to operate within the context of their user account).
