...
[![](/img/icons/dbt-bit.svg)](./downstream-exposures-tableau.md)

#### [Set up and visualize downstream exposures](./downstream-exposures-tableau.md)

[Set up downstream exposures automatically from dashboards to understand how models are used in downstream tools for a richer downstream lineage.](./downstream-exposures-tableau.md)

[![](/img/icons/dbt-bit.svg)](./orchestrate-exposures.md)

#### [Orchestrate downstream exposures](./orchestrate-exposures.md)

[Proactively refreshes the underlying data sources (like Tableau extracts) using the dbt scheduler during scheduled dbt jobs.](./orchestrate-exposures.md)
