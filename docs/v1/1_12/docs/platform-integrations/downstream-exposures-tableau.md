...
This beta capability requires deployment jobs on [**v1 Latest**](../dbt-versions/dbt-release-tracks.md) with dbt v1 and *isn't* available on [**v2 Stable**](../dbt-versions/dbt-release-tracks.md). For setup details, refer to [Orchestrate exposures](./orchestrate-exposures.md).
