...
### 5. Accept the connection request[​](#5-accept-the-connection-request "Direct link to 5. Accept the connection request")
...
3. You'll be directed to the **Add new connection** page, select **PostgreSQL**.
