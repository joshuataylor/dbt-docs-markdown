...
* **Read-Only** — Read-only access to your project, including environments and Catalog. Doesn't have access to account settings at all. Functions the same regardless of group assignments. For read-only license availability by plan, refer to [dbt pricing](https://www.getdbt.com/pricing).
...
* [Account-level permissions](#account-permissions-for-account-roles) — Permissions related to management of the dbt account. For example, billing and account settings.
* [Project-level permissions](#project-permissions-for-account-roles) — Permissions related to the projects in dbt. For example, Catalog and the Studio IDE.
...
| Develop (Studio IDE or dbt CLI) | W     | W      | -         | -          |
| Environments                    | W     | W      | R         | -          |
| Jobs                            | W     | W      | R         | -          |
| Catalog                         | W     | W      | R         | -          |
| Permissions                     | W     | R      | -         | -          |
