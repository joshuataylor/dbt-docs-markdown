...
* Uses [dbt State](https://docs.getdbt.com/docs/deploy/dbt-state-about.md) to decide what needs to be rebuilt based on upstream data freshness and code changes. [Preview](https://docs.getdbt.com/docs/dbt-versions/product-lifecycles "Go to https://docs.getdbt.com/docs/dbt-versions/product-lifecycles")
...
Refer to [dbt architecture](https://docs.getdbt.com/docs/platform/about-platform/architecture.md) for an architecture diagram and to learn how the data flows.
...
The scheduler will not cancel over-scheduled jobs triggered by the [API](https://docs.getdbt.com/docs/dbt-apis/overview.md).
...
* [dbt architecture](https://docs.getdbt.com/docs/platform/about-platform/architecture.md#dbt-cloud-features-architecture)
