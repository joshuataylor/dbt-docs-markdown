...
[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/deploy/dbt-state-about.md)

#### [dbt State](https://docs.getdbt.com/docs/deploy/dbt-state-about.md)

[Intelligently determines which models to build by detecting changes in code or data at each job run.](https://docs.getdbt.com/docs/deploy/dbt-state-about.md)
