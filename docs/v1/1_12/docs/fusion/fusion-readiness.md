...
* [ ] [Upgrade to Fusion Pt. 1: Preparing to upgrade](../../guides/prepare-fusion-upgrade.md?step=1)
* [ ] [Upgrade to Fusion Pt. 2: Making the move](../../guides/upgrade-to-fusion.md?step=1)
...
* <!-- -->
  For eligible jobs, use **Debug on Fusion** to debug in Studio IDE or run once on Fusion. Refer to [Update your jobs](../../guides/prepare-fusion-upgrade.md?step=7).
...
* <!-- -->
  Read the [Upgrade guide](../dbt-versions/core-upgrade/upgrading-to-v2.md) to learn about the new features and functionality that impact your dbt projects.
* <!-- -->
