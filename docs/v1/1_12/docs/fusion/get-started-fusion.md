...
Get Fusion's performance plus autocomplete, inline errors, and lineage in your editor.
...
[![](/img/icons/dbt-bit.svg)](../../guides/prepare-fusion-upgrade.md)

#### [Guide: Prepare to upgrade to v2](../../guides/prepare-fusion-upgrade.md)

[Step-by-step guide to prepare your dbt platform projects for upgrading to v2.](../../guides/prepare-fusion-upgrade.md)

[![](/img/icons/dbt-bit.svg)](../../guides/upgrade-to-fusion.md)

#### [Guide: Upgrade to v2](../../guides/upgrade-to-fusion.md)

[Learn how to upgrade your eligible projects on the dbt platform to v2, powered by Fusion.](../../guides/upgrade-to-fusion.md)

[![](/img/icons/dbt-bit.svg)](../../guides/fusion-platform-local-workflow.md)

#### [Guide: dbt platform and local workflows](../../guides/fusion-platform-local-workflow.md)

[Learn how to keep credentials, environment variables, and Fusion versions in sync between dbt platform and local development.](../../guides/fusion-platform-local-workflow.md)
