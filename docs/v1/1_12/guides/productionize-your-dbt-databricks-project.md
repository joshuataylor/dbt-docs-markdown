...
In dbt, [environments](https://docs.getdbt.com/docs/dbt-platform-environments.md) come in two flavors:
...
To trigger your dbt job from Databricks, follow the instructions in our [Databricks Workflows to run dbt jobs guide](https://docs.getdbt.com/guides/databricks-workflows.md).
