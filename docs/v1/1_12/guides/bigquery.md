...
7. (Optional) dbt Enterprise plans can configure developer OAuth with BigQuery, providing an additional layer of security. For more information, refer to [Set up BigQuery OAuth](../docs/platform/manage-access/set-up-bigquery-oauth.md).
