...
The [dbt Information Schema](../docs/build/dbt-information-schema.md) is a contracted interface into the metadata for all of the resources in your dbt project. Information Schema tables are produced by [`dbt build`](./commands/build.md), [`dbt run`](./commands/run.md), [`dbt compile`](./commands/compile.md), or [`dbt parse`](./commands/parse.md) with the `--generate-info-schema` flag.
...
* [dbt Information Schema](../docs/build/dbt-information-schema.md)
