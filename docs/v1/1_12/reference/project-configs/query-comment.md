...
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| dbt\_version     | The version of dbt being used. For details about release versioning, refer to [Versioning](../commands/version.md#versioning). |
| env\_var         | See [env\_var](../dbt-jinja-functions/env_var.md)                                                                              |
| modules          | See [modules](../dbt-jinja-functions/modules.md)                                                                               |
| run\_started\_at | When the dbt invocation began                                                                                                                                 |
| invocation\_id   | A unique ID for the dbt invocation                                                                                                                            |
| fromjson         | See [fromjson](../dbt-jinja-functions/fromjson.md)                                                                             |
| tojson           | See [tojson](../dbt-jinja-functions/tojson.md)                                                                                 |
| log              | See [log](../dbt-jinja-functions/log.md)                                                                                       |
| var              | See [var](../dbt-jinja-functions/var.md)                                                                                       |
| target           | See [target](../dbt-jinja-functions/target.md)                                                                                 |
