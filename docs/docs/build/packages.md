...
* You are using Fusion locally (with the [Fusion CLI](https://docs.getdbt.com/docs/fusion/install-fusion-cli.md) or the [VS Code extension](https://docs.getdbt.com/docs/fusion/install-dbt-extension.md)) (required).
