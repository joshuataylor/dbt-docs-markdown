...
* If you’re using [Fusion CLI](https://docs.getdbt.com/docs/fusion/install-fusion-cli.md) ([source available](https://www.getdbt.com/licenses-faq)) and aren't connected to dbt platform, install MetricFlow separately and use the `mf` prefix to run commands locally.
