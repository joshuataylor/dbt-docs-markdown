...
<Lightbox src="/img/docs/dbt-platform/account-integrations.png" title="Example of Account integrations from the sidebar" /> 
...
You can connect your <Constant name="dbt" /> account to additional <Constant name="git" /> providers by importing a git repository from any valid git URL. Refer to [Import a git repository](/docs/platform/git/import-a-project-by-git-url) for more information.

<Lightbox src="/img/docs/dbt-platform/account-integration-git.png" width="85%" title="Example of the Git integration page" />
...
4. For custom OAuth providers, under **Custom OAuth integrations**, click on **Add integration** and select the [OAuth provider](/docs/platform/manage-access/sso-overview) from the list. Fill in the required fields and click **Save**.

<Lightbox src="/img/docs/dbt-platform/account-integration-oauth.png" width="85%" title="Example of the OAuth integration page" />
