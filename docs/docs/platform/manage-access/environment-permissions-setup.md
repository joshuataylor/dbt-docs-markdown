...
Environment-level permissions are not the same as account-level [role-based access control (RBAC)](/docs/platform/manage-access/about-user-access#role-based-access-control) and are configured separately from those workflows.
...
<Lightbox src="/img/docs/dbt-platform/groups-and-licenses.png" width="80%" title="Groups & Licenses page in dbt with the default groups highlighted."/>
...
<Lightbox src="/img/docs/dbt-platform/add-permissions.png" width="80%" title="The Access & permissions section with the Add button highlighted."/>
...
<Lightbox src="/img/docs/dbt-platform/no-option.png" width="80%" title="The view of the permissions box if there is no option for environment permissions."/>
