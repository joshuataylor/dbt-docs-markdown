...
<Lightbox src="/img/docs/dbt-platform/platform-configuring-dbt-platform/postgres-redshift-connection.png" width="70%" title="Configuring a Postgres connection"/>
