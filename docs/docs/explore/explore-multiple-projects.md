...
For cross-project collaboration, you can interact with the DAG in all the same ways as described in [Explore your project's lineage](https://docs.getdbt.com/docs/explore/explore-projects.md#project-lineage) but you can also interact with it at the project level and view the details.
...
* Click the **List view** icon (in the graph’s upper right corner) to view the project list.
  ...
  * Select a model from the **Public Models** tab to view the [model’s details page](https://docs.getdbt.com/docs/explore/explore-projects.md#view-resource-details).
