...
| `schema`                 | Recommended. A string to add as a prefix to the names of generated tables when using the [custom schemas workaround](/docs/local/connect-data-platform/firebolt-setup#supporting-concurrent-development). |
