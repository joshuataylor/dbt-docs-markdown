...
You can use any [authentication method](/docs/local/connect-data-platform/bigquery-setup) supported in the official dbt Bigquery adapter since Layer uses `dbt-bigquery` adapter to connect to your Bigquery instance. 
