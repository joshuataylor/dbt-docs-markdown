...
You can use any [authentication method](https://docs.getdbt.com/docs/core/connect-data-platform/bigquery-setup.md) supported in the official dbt Bigquery adapter since Layer uses `dbt-bigquery` adapter to connect to your Bigquery instance.
