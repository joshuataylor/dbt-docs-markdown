...
The `dbt-databricks` adapter supports both [token-based authentication](https://docs.getdbt.com/docs/core/connect-data-platform/databricks-setup.md?tokenoauth=token#examples) and [OAuth client-based authentication](https://docs.getdbt.com/docs/core/connect-data-platform/databricks-setup.md?tokenoauth=oauth#examples).
