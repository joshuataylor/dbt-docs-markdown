...
This adapter is based on the dbt-postgres adapter documented here [Postgres profile setup](https://docs.getdbt.com/docs/core/connect-data-platform/postgres-setup.md)
