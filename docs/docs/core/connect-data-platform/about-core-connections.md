# About dbt Core data platform connections

dbt Core can connect with a variety of data platform providers including:

* [Amazon Redshift](https://docs.getdbt.com/docs/core/connect-data-platform/redshift-setup.md)
* [Apache Spark](https://docs.getdbt.com/docs/core/connect-data-platform/spark-setup.md)
* [Azure Synapse](https://docs.getdbt.com/docs/core/connect-data-platform/azuresynapse-setup.md)
* [Databricks](https://docs.getdbt.com/docs/core/connect-data-platform/databricks-setup.md)
* [Google BigQuery](https://docs.getdbt.com/docs/core/connect-data-platform/bigquery-setup.md)
* [Microsoft Fabric](https://docs.getdbt.com/docs/core/connect-data-platform/fabric-setup.md)
* [PostgreSQL](https://docs.getdbt.com/docs/core/connect-data-platform/postgres-setup.md)
* [Snowflake](https://docs.getdbt.com/docs/core/connect-data-platform/snowflake-setup.md)
* [Starburst or Trino](https://docs.getdbt.com/docs/core/connect-data-platform/trino-setup.md)

dbt communicates with a number of different data platforms by using a dedicated adapter for each. When you install dbt Core, you'll also need to install the specific adapter for your data platform, connect to dbt Core, and set up a [profiles.yml file](https://docs.getdbt.com/docs/core/connect-data-platform/profiles.yml.md). You can do this using the command line (CLI).
...
For detailed info, you can refer to the [Connection profiles](https://docs.getdbt.com/docs/core/connect-data-platform/connection-profiles.md).
...
You can measure source freshness using the warehouse metadata tables on supported adapters. This allows for calculating source freshness without using the [`loaded_at_field`](https://docs.getdbt.com/reference/resource-properties/freshness.md#loaded_at_field) and without querying the table directly. This is faster and more flexible (though it might sometimes be inaccurate, depending on how the warehouse tracks altered tables). You can override this with the `loaded_at_field` in the [source config](https://docs.getdbt.com/reference/source-configs.md). If the adapter doesn't support this, you can still use the `loaded_at_field`.
