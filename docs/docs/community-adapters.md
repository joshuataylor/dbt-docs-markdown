...
| ------------------------------------------ | -------------------------------- | ------------------------------------- |
  ...
  | [Extrica](/docs/local/connect-data-platform/extrica-setup) | [Hive](/docs/local/connect-data-platform/hive-setup) | [Hologres](/docs/local/connect-data-platform/hologres-setup) |
  | [IBM DB2](/docs/local/connect-data-platform/ibmdb2-setup) | [IBM watsonx.data - Spark](/docs/local/connect-data-platform/watsonx-spark-setup) | [Impala](/docs/local/connect-data-platform/impala-setup) |
  ...
  | [Rockset](/docs/local/connect-data-platform/rockset-setup) | [SingleStore](/docs/local/connect-data-platform/singlestore-setup) | [SQL Server & Azure SQL](/docs/local/connect-data-platform/mssql-setup) |
  | [SQLite](/docs/local/connect-data-platform/sqlite-setup) | [Starrocks](/docs/local/connect-data-platform/starrocks-setup) | [TiDB](/docs/local/connect-data-platform/tidb-setup) |
  | [TimescaleDB](https://dbt-timescaledb.debruyn.dev/) | [Upsolver](/docs/local/connect-data-platform/upsolver-setup) | [Vertica](/docs/local/connect-data-platform/vertica-setup) |
