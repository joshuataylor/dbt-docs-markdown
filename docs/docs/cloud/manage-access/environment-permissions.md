...
For configuration instructions, check out the [setup page](https://docs.getdbt.com/docs/cloud/manage-access/environment-permissions-setup.md).
...
* [Environment-level permissions setup](https://docs.getdbt.com/docs/cloud/manage-access/environment-permissions-setup.md)
