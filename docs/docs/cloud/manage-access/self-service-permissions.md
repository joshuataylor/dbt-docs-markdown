...
See [Seats and Users](https://docs.getdbt.com/docs/cloud/manage-access/seats-and-users.md) for more information on the impact of licenses on these permissions.
