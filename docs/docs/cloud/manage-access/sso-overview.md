...
This overview explains how users are provisioned in dbt via Single Sign-On (SSO). dbt supports JIT (Just-in-Time) provisioning and IdP-initiated login. You can learn more about our supported options [here](https://www.getdbt.com/pricing/).
