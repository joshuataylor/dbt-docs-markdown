...
* You must have permissions to configure the account settings in [dbt](https://docs.getdbt.com/docs/cloud/manage-access/enterprise-permissions.md) and change application settings in [Okta](https://help.okta.com/en-us/content/topics/security/administrators-admin-comparison.htm).
...
Please complete the [setup SSO with Okta](https://docs.getdbt.com/docs/cloud/manage-access/set-up-sso-okta.md) steps before configuring SCIM settings.
...
Please complete the [setup SSO with Entra ID](https://docs.getdbt.com/docs/cloud/manage-access/set-up-sso-microsoft-entra-id.md) steps before configuring SCIM settings.
...
9. Click **Ok**
   ...
   [![Edit the attribute as shown.](/img/docs/dbt-cloud/access-control/edit-attribute.png?v=2 "Edit the attribute as shown.")](#)Edit the attribute as shown.
