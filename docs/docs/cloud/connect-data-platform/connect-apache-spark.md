...
To learn how to optimize performance with data platform-specific configurations in <Constant name="dbt" />, refer to [Apache Spark-specific configuration](/reference/resource-configs/spark-configs).
