...
[![The Studio IDE in dark mode](/img/docs/dbt-cloud/cloud-ide/cloud-ide-v2.png?v=2 "The Studio IDE in dark mode")](#)The Studio IDE in dark mode

For more information, read the complete [Cloud Studio IDE guide](https://docs.getdbt.com/docs/cloud/studio-ide/develop-in-studio.md).

## Related docs[​](#related-docs "Direct link to Related docs")

* [Studio IDE user interface](https://docs.getdbt.com/docs/cloud/studio-ide/ide-user-interface.md)
