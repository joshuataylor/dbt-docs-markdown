...
[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/cloud/studio-ide/develop-in-studio.md)

#### [dbt Studio IDE](https://docs.getdbt.com/docs/cloud/studio-ide/develop-in-studio.md)

[The IDE is the easiest and most efficient way to develop dbt models, allowing you to build, test, run, and version control your dbt projects directly from your browser.](https://docs.getdbt.com/docs/cloud/studio-ide/develop-in-studio.md)
