...
[![Accept the connection request](/img/docs/dbt-cloud/cloud-configuring-dbt-cloud/accept-request.png?v=2 "Accept the connection request")](#)Accept the connection request
