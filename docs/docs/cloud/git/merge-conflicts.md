...
The <Constant name="studio_ide" /> will display:

- **Commit and resolve** git action bar under **Version Control**  instead of **Commit** &mdash; This indicates that the Cloud <Constant name="studio_ide" /> has detected some conflicts that you need to address.
...
```
- The file and path colored in red in the **File <Constant name="catalog" />**, with a warning icon to highlight files that you need to resolve.
...
You can seamlessly resolve merge conflicts that involve competing line changes in the Cloud <Constant name="studio_ide" />.

1. In the <Constant name="studio_ide" />, you can edit the right-side of the conflict file, choose which lines of code you'd like to preserve, and delete the rest. 
...
- If you open the conflict file under **File <Constant name="catalog" />**, you can edit the file in the right view.
:::
