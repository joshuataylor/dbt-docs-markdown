...
* **dbt Core** is an open-source command line tool that you can install locally in your environment, and communication with databases is facilitated through adapters.
...
[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/cloud/about-cloud-setup.md)

#### [dbt platform setup](https://docs.getdbt.com/docs/cloud/about-cloud-setup.md)

[Learn how to connect to a data platform, integrate with secure authentication methods, and configure a sync with a git repo.](https://docs.getdbt.com/docs/cloud/about-cloud-setup.md)

[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/about-dbt-install.md)

#### [dbt local setup](https://docs.getdbt.com/docs/about-dbt-install.md)

[Learn how to set up dbt locally using the dbt VS Code extension or CLI.](https://docs.getdbt.com/docs/about-dbt-install.md)
