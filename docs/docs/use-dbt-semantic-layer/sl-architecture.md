...
<Lightbox src="/img/docs/dbt-platform/semantic-layer/sl-concept.png" width="80%" title="This diagram shows how the dbt Semantic Layer works with your data stack." />
<Lightbox src="/img/docs/dbt-platform/semantic-layer/sl-architecture.jpg" width="85%" title="The diagram displays how your data flows using the dbt Semantic Layer and the variety of integration tools it supports."/>
</DocCarousel>
