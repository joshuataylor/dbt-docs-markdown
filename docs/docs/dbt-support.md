...
- Dedicated dbt Support team (<Constant name="dbt" /> users).
...
The dbt Support Assistant AI widget is separate from [<Constant name="copilot" />](/docs/platform/dbt-copilot), a powerful AI engine that helps with code generation to accelerate your analytics workflows. The dbt Support Assistant focuses on answering documentation and troubleshooting-related questions. Enabling or disabling AI features in <Constant name="dbt" /> won't affect the dbt Support Assistant's availability.
...
We want to help you work through implementing and utilizing <Constant name="dbt" /> platform at your organization. Have a question you can't find an answer to in [our docs](https://docs.getdbt.com/) or [the Community Forum](https://discourse.getdbt.com/)? Our Support team is here to `dbt help` you!
...
- **Support team help** &mdash; Assistance with [common <Constant name="dbt" /> questions](/category/troubleshooting), like project setup, login issues, error understanding, setup private packages, link to a new GitHub account, [how to generate a har file](/faqs/Troubleshooting/generate-har-file), and so on.
...
Types of dbt cloud-based platform related questions our Support team can assist you with, regardless of your <Constant name="dbt" /> plan:<br /><br />
<b>How do I...</b><br />
    - set up a <Constant name="dbt" /> project?<br />
...
<b>I need help understanding...</b><br />
    ...
    - why I am getting this error message in <Constant name="dbt" />?<br />
...
For customers on a <Constant name="dbt" /> Enterprise-tier plan, we **also** offer basic assistance in troubleshooting issues with your dbt project:
...
Leave feedback or submit a feature request for <Constant name="dbt" /> or <Constant name="core" />.

#### Share feedback or feature request for the dbt platform
1. In the <Constant name="dbt" /> navigation, click **Leave feedback**.
