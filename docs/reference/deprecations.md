...
Previously, if identical keys existed in the [`profiles.yml` file](https://docs.getdbt.com/docs/core/connect-data-platform/profiles.yml.md), dbt would use the last configuration listed in the file.
