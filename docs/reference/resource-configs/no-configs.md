# No specific configurations for this adapter
...
If you'd like to contribute to data platform-specific configuration information, refer to [Documenting a new adapter](https://docs.getdbt.com/guides/adapter-creation.md)
