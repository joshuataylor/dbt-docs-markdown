...
[](https://docs.getdbt.com/docs/local/install-dbt.md?version=2)

[](https://docs.getdbt.com/docs/local/install-dbt.md?version=2)

[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/docs/local/install-dbt.md?version=2)[Preview](https://docs.getdbt.com/docs/dbt-versions/product-lifecycles "Go to https://docs.getdbt.com/docs/dbt-versions/product-lifecycles")
...
[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/guides/prepare-fusion-upgrade.md)

#### [Guide: Prepare to upgrade to Fusion](https://docs.getdbt.com/guides/prepare-fusion-upgrade.md)

[Step-by-step guide to prepare your dbt platform projects for upgrading to Fusion.](https://docs.getdbt.com/guides/prepare-fusion-upgrade.md)

[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/guides/upgrade-to-fusion.md)

#### [Guide: Upgrade to Fusion](https://docs.getdbt.com/guides/upgrade-to-fusion.md)

[Learn how to upgrade your eligible projects on the dbt platform to the Fusion engine with this comprehensive guide.](https://docs.getdbt.com/guides/upgrade-to-fusion.md)

[![](/img/icons/dbt-bit.svg)](https://docs.getdbt.com/guides/fusion-platform-local-workflow.md)

#### [Guide: dbt platform and local workflows](https://docs.getdbt.com/guides/fusion-platform-local-workflow.md)

[Learn how to keep credentials, environment variables, and Fusion versions in sync between dbt platform and local development.](https://docs.getdbt.com/guides/fusion-platform-local-workflow.md)
