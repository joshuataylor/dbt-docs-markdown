...
3. Copy the value in the **Resource ID** field at the top of the pane.<br /><!-- -->The path format is: `/subscriptions/<subscription_uuid>/resourceGroups/<resource_group_name>/providers/Microsoft.Synapse/workspaces/<workspace_name>`.
...
3. You'll be directed to the **Add new connection** page, select **Synapse**.
