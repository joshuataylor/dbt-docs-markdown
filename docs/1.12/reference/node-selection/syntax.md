...
| command                                                                 | argument(s)                                           |
| ----------------------------------------------------------------------- | ----------------------------------------------------- |
| [run](https://docs.getdbt.com/reference/commands/run.md)                | `--select`, `--exclude`, `--defer`                    |
| [test](https://docs.getdbt.com/reference/commands/test.md)              | `--select`, `--exclude`, `--defer`                    |
| [seed](https://docs.getdbt.com/reference/commands/seed.md)              | `--select`, `--exclude`                               |
| [snapshot](https://docs.getdbt.com/reference/commands/snapshot.md)      | `--select`, `--exclude`                               |
| [ls (list)](https://docs.getdbt.com/reference/commands/list.md)         | `--select`, `--exclude`, `--resource-type`            |
| [compile](https://docs.getdbt.com/reference/commands/compile.md)        | `--select`, `--exclude`, `--inline`                   |
| [freshness](https://docs.getdbt.com/reference/commands/source.md)       | `--select`, `--exclude`                               |
| [build](https://docs.getdbt.com/reference/commands/build.md)            | `--select`, `--exclude`, `--resource-type`, `--defer` |
| [docs generate](https://docs.getdbt.com/reference/commands/cmd-docs.md) | `--select`, `--exclude`                               |
...
You can reference a named selector using the `selector:` method with `--select` or `--exclude`. To learn more, refer to [`selector:` method](https://docs.getdbt.com/reference/node-selection/methods.md#selector).
...
You can reference a predefined selector using the `selector:` method when using `--select` or `--exclude`. To learn more, refer to [`selector:` method](https://docs.getdbt.com/reference/node-selection/methods.md#selector).
