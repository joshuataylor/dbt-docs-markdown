...
* There are slightly different naming conventions for properties and configs depending on the file type. Refer to [naming convention](https://docs.getdbt.com/reference/dbt_project.yml.md#naming-convention) for more details.
...
* Assert "truths" about a model, in the form of [data tests](https://docs.getdbt.com/docs/build/data-tests.md), e.g. "this `id` column is unique"
* Define official downstream uses of your data models, in the form of [exposures](https://docs.getdbt.com/docs/build/exposures.md), and assert an exposure's "type"
