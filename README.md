...
- Convert `<br>` to line breaks in generated Markdown, for example: https://docs.getdbt.com/reference/function-configs.md.
  ...
  After:
    ...
    ~~~
- Remove empty navigation links (the guide "Menu" toggle and version switcher) that pointed nowhere.
- Strip leftover invisible zero-width characters from some headings.
- Drop the stray product/difficulty tags at the top of guide pages.
- Give a behaviour-flag page a description so its card shows a summary instead of a stray table row.
